...
module Playlyfe
  ...
  class ConnectionTest < Playlyfe::Test
    ...
    def test_whole_in_one_run
     # my_test_invalid_client
     # my_test_wrong_init
     # my_test_init_staging_v1

      set_conn_v2
      my_test_get_game_info
      #my_test_get_teams
    ...
    private  
      ...
      def set_conn_v2
        #do not know correct api for  players and so on, SDK have tests only for API V1
        @pl = Playlyfe::Connection.new(
          version: 'v2',
          client_id: "Zjc0MWU0N2MtODkzNS00ZWNmLWEwNmYtY2M1MGMxNGQ1YmQ4",
          client_secret: "YzllYTE5NDQtNDMwMC00YTdkLWFiM2MtNTg0Y2ZkOThjYTZkMGIyNWVlNDAtNGJiMC0xMWU0LWI2NGEtYjlmMmFkYTdjOTI3",
      ...
      def my_test_init_staging_v1
        ...
        refute_nil players["data"]
        refute_nil players["data"][0]
      end  

      def my_test_get_game_info
        game=Playlyfe::Game.find_by_connection(@pl)
        binding.pry
      end  

      def my_test_get_teams
        player_id = 'student1'
        teams=@pl.get('/teams',{ player_id: 'student1'})
        binding.pry
      end  
