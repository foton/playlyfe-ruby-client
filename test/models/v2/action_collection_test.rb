...
module PlaylyfeClient
  class ActionCollectionTest < PlaylyfeClient::Test
    ...
    def setup
      ...
      stub_all_actions_query do
        @collection = PlaylyfeClient::V2::ActionCollection.new(@game)
      end  
      
    end  

    def test_build_from_game
      assert_equal PlaylyfeClient::Testing::ExpectedResponses.full_all_actions_array.size, @collection.size
    end  

    def test_can_find_action_by_id
       PlaylyfeClient::Testing::ExpectedResponses.full_all_actions_array.each do |exp_action|
    ...
    def test_can_convert_to_array  
      ...
      assert_equal PlaylyfeClient::Testing::ExpectedResponses.full_all_actions_array.size, @collection.to_a.size
    end
